...
#     physical_controller_1 = PhysicalController(adc_pins=[26, 27], digital_pins=[])
#     physical_controller_2 = PhysicalController(adc_pins=[28, 29], digital_pins=[])

#     transmitter = SignalTransmitter(
#         controllers=[physical_controller_1, physical_controller_2]
#     )
